...
export const ContactSection = () => {
  return (
    <section id="contact" className="min-h-screen bg-foreground text-background py-32 px-6 flex flex-col justify-between">
      <div className="max-w-[90vw] mx-auto w-full flex-grow flex flex-col justify-center">
        ...
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 font-sans text-sm tracking-widest uppercase font-medium">
          <a href="mailto:hello@example.com" className="hover:text-background/50 transition-colors border-b border-transparent hover:border-background/50 pb-1 w-fit">
            Email
          </a>
          ...
          <a href="https://linkedin.com" target="_blank" rel="noreferrer" className="hover:text-background/50 transition-colors border-b border-transparent hover:border-background/50 pb-1 w-fit">
            LinkedIn
          </a>
        </div>
      </div>
